...
attack_zoo = {
    ...
    'test_rotation': ('.gradient.improve_with_cos', 'PerImageHistoricalAttack'),
    'test_1': ('.gradient.test_1', 'HistoricalNeighborhoodSearchAttack'),
    ...
    'test': ('.test_grad.grad_ensumble', 'GradientDiversityAttack'),
    'debug_test':('.adptive_block.debugtest', 'SaliencyGuidedBSR'),
    'my': ('.my', 'BSR'),
    ...
    '': ('.input_transformation.sia', 'SIAWithSaliency'),
    ...
    'test': ('.input_transformation.89', 'BSR'),
    'shuffle_crop_mirrora': ('.shuffle_crop_mirror.shuffle_crop_mirror', 'BSR'),
    'adptive': ('.adptive_block.test', 'SaliencyGuidedBSR'),
    ## Targeted
    ...
    'fia': ('.advanced_objective.fia_with_variance', 'ImprovedFIANoMomentum'),
